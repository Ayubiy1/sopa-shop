  ...
  return (
    <>
      ...
      <div className="mt-10">
        <Carousel autoplay>
          {data?.data
            .filter((products: Products) => products.status == "new")
            .map((product: Products) => {
              return (
                <div key={product.id} className="relative bg-[#f2f2f2] p-10">
                  <div className="h-[500px] mx-auto">
                    <img
                      src={product?.img}
                      className="w-[80%] h-[100%] mx-auto object-cover cursor-pointer"
                      alt=""
                    />

                    <p className="m-0 text-[44px] absolute top-[35px] left-[170px]">
                      {product?.name}
                    </p>
                  </div>
                </div>
        ...
        <div className="mt-20 bg-[#f2f2f2] p-10 rounded-lg">
          <p
            className="m-0 font-bold text-[40px] text-center"
            style={{ fontFamily: "Noto Serif Lao" }}
          >
            “These are the most thoughtfully designed <br /> sneakers on the
            markets.”
          </p>
          ...
          <div className="flex items-center justify-between">
            ...
            <h3 className="text-[#75869C] font-bold text-[60px] cursor-pointer">
              esquire
            </h3>

            <p
              className="m-0 text-[#75869C] text-end cursor-pointer"
              style={{ fontFamily: "Rubik" }}
            >
              HUMANS OF <br /> NEW YORK
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="mt-20 text-center">
        <div className="text-start flex items-center justify-between">
          <h1 className="text-[30px] font-bold">Check out the collection</h1>
          <p>Shop Now</p>
        </div>
